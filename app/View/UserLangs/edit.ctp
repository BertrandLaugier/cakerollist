...
<?php echo $this->Form->create('UserLang'); ?>
	<fieldset>
		<legend><?php echo __('Edit User Lang'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UserLang.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('UserLang.id'))); ?></li>
